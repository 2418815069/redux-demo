    ...
    <div style={{ 'padding-bottom': 60 }}>
      ...
      <FlexHistory onClick={handleOtherIllRadio}>
        <FlexItem className="historyItem">
          <Lable>高血压</Lable>
          <Field name="otherill1" component={ARadioGroup} value="1">
        ...
        <FlexItem className="historyItem">
          <Lable>血脂异常</Lable>
          <Field name="otherill2" component={ARadioGroup} value="1">
            <Radio value={1}>有</Radio>
            <Radio value={2}>无</Radio>
          </Field>
        </FlexItem>
        <FlexItem className="historyItem">
          <Lable>糖尿病</Lable>
          <Field name="otherill3" component={ARadioGroup} value="">
            <Radio value={1}>有</Radio>
            <Radio value={2}>无</Radio>
          </Field>
        </FlexItem>
        <FlexItem className="historyItem">
          <Lable>心梗病史</Lable>
          <Field name="otherill4" component={ARadioGroup} value="">
            <Radio value={1}>有</Radio>
            <Radio value={2}>无</Radio>
          </Field>
        </FlexItem>
        <FlexItem className="historyItem">
          <Lable>吸烟史</Lable>
          <Field name="otherill5" component={ARadioGroup} value="">
            <Radio value={1}>有</Radio>
            <Radio value={2}>无</Radio>
          </Field>
        </FlexItem>
