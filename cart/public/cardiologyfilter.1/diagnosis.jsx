      ...
      <FlexItem>
        <FlexCheckbox>
          ...
          <div className="flexCheck" onClick={handleDiagnosisRadio}>
            ...
            <Field name="clinicalDiagnosis2" component={ACheckBox} type="checkbox">
              稳定性心绞痛
            </Field>
            <Field name="clinicalDiagnosis3" component={ACheckBox} type="checkbox">
              不稳定性心绞痛
            </Field>
            <Field
              name="clinicalDiagnosis4"
              component={ACheckBox}
              type="checkbox"
              className="checkboxICA"
            >
            ...
            <Field name="clinicalDiagnosis5" component={ACheckBox} type="checkbox">
              ST段抬高性
            </Field>
            <Field name="clinicalDiagnosis6" component={ACheckBox} type="checkbox">
              非ST段抬高性
            </Field>
            <Field name="clinicalDiagnosis7" component={ACheckBox} type="checkbox">
              其他
            </Field>
            <Field
              name="diagnosisInput"
            ...
            />
            {/*
            <Field name="diagnosisRadio" component={ACheckBox}>
              ...
              <FlexBox style={{ 'min-width': 250, margin: '16px 0' }}>
                ...
                <HidenSelect>
                  <Field name="radioSt" component={ACheckBox}>
